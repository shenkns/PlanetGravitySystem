...
UCLASS()
class PLANETGRAVITYSYSTEM_API UGravityMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
public:
	...
	{
		return FGravityMath::GetAxisX(UpdatedComponent->GetComponentQuat());
	}
	...
	{
		return FGravityMath::GetAxisY(UpdatedComponent->GetComponentQuat());
	}
	...
	{
		return FGravityMath::GetAxisZ(UpdatedComponent->GetComponentQuat());
	}
